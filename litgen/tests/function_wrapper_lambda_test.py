...
def test_make_function_wrapper_lambda():
    ...
    #     srcml_xml = srcml.srcml_caller.code_to_srcml(code)
    #     for child in srcml.srcml_comments.get_children_with_comments(srcml_xml):
    #         if child.tag() == "function" or child.tag() == "function_decl":
    #             fn_info = cpp_elements.srcml_function_to_cpp_function_decl(child, options)
