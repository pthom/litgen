...
def test_generate_pydef_enum():
    ...
    generated_code = module_pydef_generator.generate_pydef(code1, options)
    code_utils.assert_are_codes_equal(expected_generated_code1, generated_code)
    ...
    expected_generated_code2 = """
        ...
        ;
    """
    generated_code = module_pydef_generator.generate_pydef(code2, options)
    code_utils.assert_are_codes_equal(expected_generated_code2, generated_code)
