...
** Styling
  Review styling / scroll too dark

** Add immvision

immvision enabled only if opencv found!

Strategy / install opencv
  Via apt ou brew par default
  Si pas trouvé test via conan


Disable by default
Install doc in readme (cf cmake)
Use conan for pip ???
