...
arg, faut-il remettre les "=" dans les stub / enum ?
  Il semble que l'autocompletion en a besoin
  Sinon, mettre = auto() + from enum import Enum, auto
  https://docs.python.org/3/library/enum.html#using-automatic-values

*** integration test
  replace amalgamation by several files processed?
