...
** Renaming ImGui[A-Z]
    ...
    code_replacements / names_replacements / comments_replacements
      => need:
      X class_names_replacements,
      X functions_names_replacements,
      X var_names_replacements,
      X types_replacements,
      X value_replacements (qui contient types_replacements)
      X Add EnumReplacement => missing in ImGui...

      X 2 pb sur ImPlotSetImGuiContext: renaming raté + Context ImGui qui va clasher apres remove ImPlot
