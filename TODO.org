...
Add pylint or flake8 to precommit (cf  https://stackoverflow.com/questions/73765587/how-to-get-a-warning-about-a-list-being-global-when-used-as-a-default-argument))
    => permettra peut-etre de trouver issue / BoxedType registry lors de pytest
finish imgui test
Pourcentage d'avancement & Profiling
...
Fix Case with lambdas:
  qualified name
  put BoxedTypes in Litgen namespace & store file in litgen (remove generation code)
  ==> Non !!! Besoin de pydef et de stub!!!

(remove using namespace ImGui in pybind_imgui.cpp)
