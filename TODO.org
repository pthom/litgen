...
Line IM_MSVC_RUNTIME_CHECKS_OFF => add ;
IM_MSVC_RUNTIME_CHECKS_OFF; idem

header_filter_acceptable_suffixes should be a regex
IMGUI_HAS_DOCK

Warning:A cpp element of type "function" was ignored. Details follow
Warning: Can't find type name
While parsing a "type", corresponding to this C++ code:
/Users/pascal/dvp/OpenSource/ImGuiWork/litgen/demos/litgen/lg_imgui_bundle/external/imgui/imgui.h:2475:5
        inline operator ImVec4() const                                  { return Value; }


        => was ignored : => was stored as unprocessed

srcmlcpp: Create CppElements.................  100.0% - Line 3322/3322
Warning: AdaptedClassMember: Can't parse the size of this array.
Hint: use a vector, or extend `options.c_array_numeric_member_types`
While parsing a "decl", corresponding to this C++ code:
/Users/pascal/dvp/OpenSource/ImGuiWork/litgen/demos/litgen/lg_imgui_bundle/external/imgui/imgui.h:1960:5
...
** Separate litgen and srmclcpp folders
