...
mypy: enable strict
   see https://emplocity.com/en/about-us/blog/mypy_not_enough/
...
X Savoir gerer plusieurs occurences du meme namespace

ignore anonymous namespaces
do not duplicate stub creation code
add options_customized/

add internal/context/ (lg_context, namespaces_code_tree, replacement_cache_draft)
