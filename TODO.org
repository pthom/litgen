...
Handle default value for string, know types, etc. / may be exclude those that don't have default value
opt-in add when there is a default?
Filter litgen & srcmlcpp errors
Profile litgen imgui & finish cache scope ?


** Scratch
pybind_hello_imgui.cpp => namespace annnotation disappeared!
namespace_test / bug dbl namespace inner2
...
** EasyRunner:
     AutoGenerate named constructors
