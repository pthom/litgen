...
*** X Correct CI
     X Limit cibuildwheel versions

*** X Pub ImGuiBundle dans HelloImGui
...
Bug sur plots:
  bar = np.array([1,2,5,3,4,1,2,5,3,4], np.float64) bien dessiné
  bar = np.array([1,2,5,3,4,1,2,5,3,4]) mal dessiné
  study mixed plot



  else if (values_type == 'L') // size=4 ie 32 bits under windows!
