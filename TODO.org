...
Il faut d'abord evaluer ce code: Ctrl-space to select, M-x "eval-region"
Ensuite, "M-a s" (Alt-a, puis s)
...
** License:
    ...
    https://github.com/ml5js/Code-of-Conduct
...
** Bind SDL:
  sdl_window_hello_imgui cassé
  info / github issue

** user Gallery on github


* Mandel:

See https://jmaio.dev/mandelbrot-maps#/m@0.2361652,0.5633767,4,0.2/j@0.4364131,-0.6468786,4,2.12


* Reddit Post / Chat GPT
  Dire que l'IA n'est qu'un outil pourrait être comparé à dire
  que la chimie  n'est qu'un outil.

  Oui, la chimie est peut-être un outil, mais c'est un outil qui permet de créer plein de choses,
  certaines peuvent être utilisées pour le plus grand bien de tous, et certaines peuvent présenter
  un danger général pour la population si elles sont mal utilisées et déployées à large
  et pourtant plein de régulation existent pour nous
  protéger contre les additifs que voudraient rajouter les industriels dans nos aliments

  Avec la chimie, on peut créer des substance hautement addictives

  Si j'étais a la tête de Wagner, je
