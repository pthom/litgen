...
** Wish List / Easy
Call stack warning pas bonne (dans autogen_mylib), mais bonne dans unit test!
Renommer package de lg_skbuild_template (example-lib => lg-example-lib) ?
enum / py::arithmetic() : add an option?
Bug still ? Static methods: cf https://pybind11-jagerman.readthedocs.io/en/stable/classes.html?highlight=static%20method#instance-and-static-fields
        use def_static
