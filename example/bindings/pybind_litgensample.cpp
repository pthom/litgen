...
#include <stdio.h>
#include "/Users/pascal/dvp/OpenSource/ImGuiWork/litgen/examples_real_libs/imgui/pybind11/tests/constructor_stats.h"
...
void py_init_module_litgensample(py::module& m)
{
    ...
    py::class_<A>(m, "A").def(py::init<int>()).def("__repr__", &A::toString);
    ...
    auto pyClassBoxedUnsignedLong = py::class_<BoxedUnsignedLong>
        ...
        .def(py::init<unsigned long>(),
            py::arg("v") = 0)
        .def("__repr__",
            [](const BoxedUnsignedLong & self) -> std::string
            {
