...
void py_init_module_litgensample(py::module& m)
{
    ...
    auto pyClassBoxedInt = py::class_<BoxedInt>    // example_library/litgensample.h:26
        (m, "BoxedInt", "")
        .def(py::init<>()) // implicit default constructor
        .def_readwrite("value", &BoxedInt::value, "")    // example_library/litgensample.h:28
        ;


    // <namespace LiterateGeneratorExample>    // example_library/litgensample.h:33
    py::enum_<MyEnum>(m, "MyEnum", py::arithmetic(), " A super nice enum\n for demo purposes ( bool val = False )")    // example_library/litgensample.h:38
    ...
    m.def("add_c_array2",    // example_library/litgensample.h:61
    ...
    m.def("log_c_array2",    // example_library/litgensample.h:62
        [](const std::array<int, 2>& values)
        {
    ...
    m.def("change_c_array2",    // example_library/litgensample.h:63
    ...
    auto pyClassPoint2 = py::class_<Point2>    // example_library/litgensample.h:69
        (m, "Point2", "Test with C array containing user defined struct (which will not be boxed)")
        .def(py::init<>()) // implicit default constructor
        .def_readwrite("x", &Point2::x, "")    // example_library/litgensample.h:71
        .def_readwrite("y", &Point2::y, "")    // example_library/litgensample.h:71
        ;


    m.def("get_points",    // example_library/litgensample.h:73
    ...
    m.def("add_inside_buffer",    // example_library/litgensample.h:80
    ...
    m.def("buffer_sum",    // example_library/litgensample.h:86
    ...
    m.def("add_inside_two_buffers",    // example_library/litgensample.h:94
    ...
    m.def("mul_inside_buffer",    // example_library/litgensample.h:105
    ...
    m.def("c_string_list_total_size",    // example_library/litgensample.h:115
    ...
    m.def("add",    // example_library/litgensample.h:127
        [](int a, int b)
        {
            return add(a, b);
        },
    ...
    m.def("sub",    // example_library/litgensample.h:133
        [](int a, int b)
        {
            return sub(a, b);
        },
    ...
    m.def("mul",    // example_library/litgensample.h:135
        [](int a, int b)
        {
            return mul(a, b);
        },
    ...
    auto pyClassFoo = py::class_<Foo>    // example_library/litgensample.h:138
        (m, "Foo", "A superb struct")
        .def(py::init<>())    // example_library/litgensample.h:140
        .def_property("values",    // example_library/litgensample.h:150
            ...
            "")
        .def_property("flags",    // example_library/litgensample.h:151
            [](Foo &self) -> pybind11::array
            {
            ...
            "")
        .def_readwrite("factor", &Foo::factor, "Multiplication factor")    // example_library/litgensample.h:157
        .def_readwrite("delta", &Foo::delta, "addition factor")    // example_library/litgensample.h:160
        .def("calc",    // example_library/litgensample.h:167
            [](Foo & self, int x)
            {
                return self.calc(x);
            },
    ...
    m.def("foo_instance",    // example_library/litgensample.h:172
        []()
        {
            return FooInstance();
        },
