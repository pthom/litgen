...
def autogenerate_immvision():
    ...
    #
    pydef_codes_structs = code_generator.find_pydefs_cpp(
        whole_header_cpp_code, code_generator.CppCodeType.STRUCT
    )
    generated_files_structs = [
        code_generator.AutoGeneratedFile_StructInfos(
            "pybind/src_cpp/pydef_image.cpp",
            "pydef_struct",
            code_generator.generate_pydef_struct_cpp_code,
        ),
        code_generator.AutoGeneratedFile_StructInfos(
            "pybind/src_python/immvision/__init__.py",
            "init_struct",
            code_generator.generate_init_struct_python_code,
        ),
        code_generator.AutoGeneratedFile_StructInfos(
            "pybind/src_python/immvision/_cpp_immvision.pyi",
            "pyi",
        ...
        code_generator.AutoGeneratedFile_StructInfos(
            "src/immvision/internal/misc/immvision_to_string.h",
            "tostring_decl",
    ...
    for generated_file in generated_files_structs:
        ...
        for pydef_code_struct in pydef_codes_structs:
            struct_infos = code_generator.extract_struct_infos(
                pydef_code_struct, code_style_options
            )
            generated_code += generated_file.generator_function(
                struct_infos, code_style_options
            )
    ...
    #
    pydef_codes_functions = code_generator.find_pydefs_cpp(
        whole_header_cpp_code, code_generator.CppCodeType.FUNCTION
    )
    ...
    for generated_file in generated_files_functions:
        ...
        for pydef_code_function in pydef_codes_functions:
            function_infos = code_generator.extract_function_infos(
                pydef_code_function, code_style_options
            )
            generated_code += generated_file.generator_function(
                function_infos, code_style_options
            )
