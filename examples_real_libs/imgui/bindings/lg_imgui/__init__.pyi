...
def input_text(label: str, str: BoxedString, flags: ImGuiInputTextFlags = 0, user_data: Any = None) -> bool:    # imgui_stdlib.h:15
    pass
...
def input_text_multiline(label: str, str: BoxedString, size: ImVec2 = ImVec2(0, 0), flags: ImGuiInputTextFlags = 0, user_data: Any = None) -> bool:    # imgui_stdlib.h:16
    pass
...
# }
def input_text_with_hint(label: str, hint: str, str: BoxedString, flags: ImGuiInputTextFlags = 0, user_data: Any = None) -> bool:    # imgui_stdlib.h:17
    pass
# </Namespace ImGui>
####################    </generated_from:imgui_stdlib.h>    ####################
