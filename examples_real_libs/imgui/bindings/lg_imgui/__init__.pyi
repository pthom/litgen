...
class BoxedFloat:    # imgui.h:1
    ...
    def __repr__(self) -> str:                    # imgui.h:5
        pass
class BoxedString:    # imgui.h:1
    # std::string value;    /* original C++ signature */
    value:str                                   # imgui.h:3
    # BoxedString(std::string v = "") : value(v) {}    /* original C++ signature */
    def __init__(self, v: str = "") -> None:    # imgui.h:4
        pass
    # std::string __repr__() const { return std::string("BoxedString(") + value + ")"; }    /* original C++ signature */
    def __repr__(self) -> str:                  # imgui.h:5
        pass
...
def radio_button(label: str, v: BoxedInt, v_button: int) -> bool:    # imgui.h:504
