...
void py_init_module_imgui(py::module& m)
{
    ...
    auto pyClassBoxedBool = py::class_<BoxedBool>    // imgui.h:1
        ...
        .def("__repr__",    // imgui.h:5
            [](const BoxedBool & self) -> std::string
            {
    ...
    auto pyClassBoxedInt = py::class_<BoxedInt>    // imgui.h:1
        ...
        .def(py::init<int>(),    // imgui.h:4
            py::arg("v") = 0)
        .def("__repr__",    // imgui.h:5
            [](const BoxedInt & self) -> std::string
            {
                return self.__repr__();
            }
        )
    ...
    auto pyClassBoxedUnsignedInt = py::class_<BoxedUnsignedInt>    // imgui.h:1
        ...
        .def(py::init<unsigned int>(),    // imgui.h:4
            py::arg("v") = 0)
        .def("__repr__",    // imgui.h:5
            [](const BoxedUnsignedInt & self) -> std::string
            {
                return self.__repr__();
            }
        )
    ...
    auto pyClassBoxedFloat = py::class_<BoxedFloat>    // imgui.h:1
        ...
        .def(py::init<float>(),    // imgui.h:4
            py::arg("v") = 0.)
        .def("__repr__",    // imgui.h:5
            [](const BoxedFloat & self) -> std::string
            {
                return self.__repr__();
            }
        )
    ...
    auto pyClassBoxedDouble = py::class_<BoxedDouble>    // imgui.h:1
        ...
        .def(py::init<double>(),    // imgui.h:4
            py::arg("v") = 0.)
        .def("__repr__",    // imgui.h:5
            [](const BoxedDouble & self) -> std::string
            {
                return self.__repr__();
            }
        )
    ...
    m.def("create_context",    // imgui.h:284
        [](ImFontAtlas * shared_font_atlas = NULL) -> ImGuiContext *
        {
    ...
    m.def("begin_child",    // imgui.h:336
        [](const char * str_id, const ImVec2 & size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0) -> bool
        {
    ...
    m.def("begin_child",    // imgui.h:337
        [](ImGuiID id, const ImVec2 & size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0) -> bool
        {
    ...
    m.def("is_window_focused",    // imgui.h:344
        [](ImGuiFocusedFlags flags = 0) -> bool
        {
    ...
    m.def("is_window_hovered",    // imgui.h:345
        [](ImGuiHoveredFlags flags = 0) -> bool
        {
    ...
    m.def("get_color_u32",    // imgui.h:418
        [](ImGuiCol idx, float alpha_mul = 1.0f) -> ImU32
        {
    ...
    m.def("get_id",    // imgui.h:471
        [](const char * str_id_begin, const char * str_id_end) -> ImGuiID
        {
    ...
    m.def("button",    // imgui.h:492
        [](const char * label, const ImVec2 & size = ImVec2(0, 0)) -> bool
        {
    ...
    m.def("invisible_button",    // imgui.h:494
        [](const char * str_id, const ImVec2 & size, ImGuiButtonFlags flags = 0) -> bool
        {
    ...
    m.def("image_button",    // imgui.h:497
        [](ImTextureID user_texture_id, const ImVec2 & size, const ImVec2 & uv0 = ImVec2(0, 0), const ImVec2 & uv1 = ImVec2(1,1), int frame_padding = -1, const ImVec4 & bg_col = ImVec4(0,0,0,0), const ImVec4 & tint_col = ImVec4(1,1,1,1)) -> bool
        {
    ...
    m.def("begin_combo",    // imgui.h:509
        [](const char * label, const char * preview_value, ImGuiComboFlags flags = 0) -> bool
        {
    ...
    m.def("drag_scalar",    // imgui.h:537
        [](const char * label, ImGuiDataType data_type, void * p_data, float v_speed = 1.0f, const void * p_min = NULL, const void * p_max = NULL, const char * format = NULL, ImGuiSliderFlags flags = 0) -> bool
        {
    ...
    m.def("slider_scalar_n",    // imgui.h:556
        [](const char * label, ImGuiDataType data_type, void * p_data, int components, const void * p_min, const void * p_max, const char * format = NULL, ImGuiSliderFlags flags = 0) -> bool
        {
    ...
    m.def("v_slider_scalar",    // imgui.h:559
        [](const char * label, const ImVec2 & size, ImGuiDataType data_type, void * p_data, const void * p_min, const void * p_max, const char * format = NULL, ImGuiSliderFlags flags = 0) -> bool
        {
    ...
    m.def("input_text",    // imgui.h:564
        [](const char * label, char * buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void * user_data = NULL) -> bool
        {
    ...
    m.def("input_text_multiline",    // imgui.h:565
        [](const char * label, char * buf, size_t buf_size, const ImVec2 & size = ImVec2(0, 0), ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void * user_data = NULL) -> bool
        {
    ...
    m.def("input_text_with_hint",    // imgui.h:566
        [](const char * label, const char * hint, char * buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void * user_data = NULL) -> bool
        {
    ...
    m.def("input_scalar",    // imgui.h:576
        [](const char * label, ImGuiDataType data_type, void * p_data, const void * p_step = NULL, const void * p_step_fast = NULL, const char * format = NULL, ImGuiInputTextFlags flags = 0) -> bool
        {
    ...
    m.def("input_scalar_n",    // imgui.h:577
        [](const char * label, ImGuiDataType data_type, void * p_data, int components, const void * p_step = NULL, const void * p_step_fast = NULL, const char * format = NULL, ImGuiInputTextFlags flags = 0) -> bool
        {
    ...
    m.def("color_button",    // imgui.h:586
        [](const char * desc_id, const ImVec4 & col, ImGuiColorEditFlags flags = 0, const ImVec2 & size = ImVec2(0, 0)) -> bool
        {
    ...
    m.def("selectable",    // imgui.h:612
        [](const char * label, bool selected = false, ImGuiSelectableFlags flags = 0, const ImVec2 & size = ImVec2(0, 0)) -> bool
        {
    ...
    m.def("begin_menu",    // imgui.h:649
        [](const char * label, bool enabled = true) -> bool
        {
    ...
    m.def("begin_popup",    // imgui.h:673
        [](const char * str_id, ImGuiWindowFlags flags = 0) -> bool
        {
    ...
    m.def("begin_popup_context_item",    // imgui.h:695
        [](const char * str_id = NULL, ImGuiPopupFlags popup_flags = 1) -> bool
        {
    ...
    m.def("is_popup_open",    // imgui.h:703
        [](const char * str_id, ImGuiPopupFlags flags = 0) -> bool
        {
    ...
    m.def("begin_table",    // imgui.h:728
        [](const char * str_id, int column, ImGuiTableFlags flags = 0, const ImVec2 & outer_size = ImVec2(0.0f, 0.0f), float inner_width = 0.0f) -> bool
        {
    ...
    m.def("table_get_column_flags",    // imgui.h:758
        [](int column_n = -1) -> ImGuiTableColumnFlags
        {
    ...
    m.def("begin_tab_bar",    // imgui.h:774
        [](const char * str_id, ImGuiTabBarFlags flags = 0) -> bool
        {
    ...
    m.def("tab_item_button",    // imgui.h:778
        [](const char * label, ImGuiTabItemFlags flags = 0) -> bool
        {
    ...
    m.def("begin_drag_drop_source",    // imgui.h:796
        [](ImGuiDragDropFlags flags = 0) -> bool
        {
    ...
    m.def("set_drag_drop_payload",    // imgui.h:797
        [](const char * type, const void * data, size_t sz, ImGuiCond cond = 0) -> bool
        {
    ...
    m.def("accept_drag_drop_payload",    // imgui.h:800
        [](const char * type, ImGuiDragDropFlags flags = 0) -> const ImGuiPayload *
        {
    ...
    m.def("is_item_clicked",    // imgui.h:827
        [](ImGuiMouseButton mouse_button = 0) -> bool
        {
    ...
    m.def("begin_child_frame",    // imgui.h:861
        [](ImGuiID id, const ImVec2 & size, ImGuiWindowFlags flags = 0) -> bool
        {
    ...
    m.def("calc_text_size",    // imgui.h:865
        [](const char * text, const char * text_end = NULL, bool hide_text_after_double_hash = false, float wrap_width = -1.0f) -> ImVec2
        {
    ...
    m.def("is_mouse_clicked",    // imgui.h:891
        [](ImGuiMouseButton button, bool repeat = false) -> bool
        {
    ...
    m.def("is_mouse_dragging",    // imgui.h:900
        [](ImGuiMouseButton button, float lock_threshold = -1.0f) -> bool
        {
    ...
    m.def("get_mouse_drag_delta",    // imgui.h:901
        [](ImGuiMouseButton button = 0, float lock_threshold = -1.0f) -> ImVec2
        {
    ...
    m.def("save_ini_settings_to_memory",    // imgui.h:919
        [](size_t * out_ini_size = NULL) -> const char *
        {
    ...
    auto pyClassImGuiStyle = py::class_<ImGuiStyle>    // imgui.h:1838
        ...
        .def_readwrite("indent_spacing", &ImGuiStyle::IndentSpacing, "Horizontal indentation when e.g. entering a tree node. Generally == (FontSize + FramePadding.x*2).")    // imgui.h:1859
        ...
        .def_readwrite("tab_min_width_for_close_button", &ImGuiStyle::TabMinWidthForCloseButton, "Minimum width for close button to appears on an unselected tab when hovered. Set to 0.0 to always show when hovering, set to FLT_MAX to never show close button unless selected.")    // imgui.h:1868
    ...
    auto pyClassImGuiIO = py::class_<ImGuiIO>    // imgui.h:1903
        ...
        .def_readonly("ini_filename", &ImGuiIO::IniFilename, "= \"imgui.ini\"    // Path to .ini file (important: default \"imgui.ini\" is relative to current working dir!). Set None to disable automatic .ini loading/saving or if you want to manually call LoadIniSettingsXXX() / SaveIniSettingsXXX() functions.")    // imgui.h:1914
        .def_readonly("log_filename", &ImGuiIO::LogFilename, "= \"imgui_log.txt\"// Path to .log file (default parameter to ImGui::LogToFile when no file is specified).")    // imgui.h:1915
        .def_readwrite("mouse_double_click_time", &ImGuiIO::MouseDoubleClickTime, "= 0.30          // Time for a double-click, in seconds.")    // imgui.h:1916
        .def_readwrite("mouse_double_click_max_dist", &ImGuiIO::MouseDoubleClickMaxDist, "= 6.0           // Distance threshold to stay in to validate a double-click, in pixels.")    // imgui.h:1917
        ...
        .def_readonly("backend_platform_name", &ImGuiIO::BackendPlatformName, "= None")    // imgui.h:1945
        .def_readonly("backend_renderer_name", &ImGuiIO::BackendRendererName, "= None")    // imgui.h:1946
    ...
    auto pyClassImGuiTextFilter = py::class_<ImGuiTextFilter>    // imgui.h:2181
        ...
        .def("draw",    // imgui.h:2184
            [](ImGuiTextFilter & self, const char * label = "Filter (inc,-exc)", float width = 0.0f) -> bool
            {
        ...
        .def("pass_filter",    // imgui.h:2185
            [](const ImGuiTextFilter & self, const char * text, const char * text_end = NULL) -> bool
            {
    ...
    auto pyClassImGuiStorage = py::class_<ImGuiStorage>    // imgui.h:2235
        ...
        .def("get_int",    // imgui.h:2253
            [](const ImGuiStorage & self, ImGuiID key, int default_val = 0) -> int
            {
        ...
        .def("get_bool",    // imgui.h:2255
            [](const ImGuiStorage & self, ImGuiID key, bool default_val = false) -> bool
            {
        ...
        .def("get_float",    // imgui.h:2257
            [](const ImGuiStorage & self, ImGuiID key, float default_val = 0.0f) -> float
            {
        ...
        .def("get_void_ptr",    // imgui.h:2259
            [](const ImGuiStorage & self, ImGuiID key) -> void *
            {
        ...
        .def("get_int_ref",    // imgui.h:2266
            [](ImGuiStorage & self, ImGuiID key, int default_val = 0) -> int *
            {
        ...
        .def("get_bool_ref",    // imgui.h:2267
            [](ImGuiStorage & self, ImGuiID key, bool default_val = false) -> bool *
            {
        ...
        .def("get_float_ref",    // imgui.h:2268
            [](ImGuiStorage & self, ImGuiID key, float default_val = 0.0f) -> float *
            {
        ...
        .def("get_void_ptr_ref",    // imgui.h:2269
            [](ImGuiStorage & self, ImGuiID key, void * default_val = NULL) -> void * *
            {
    ...
    auto pyClassImDrawCmd = py::class_<ImDrawCmd>    // imgui.h:2398
        ...
        .def_readwrite("clip_rect", &ImDrawCmd::ClipRect, "4*4  // Clipping rectangle (x1, y1, x2, y2). Subtract ImDrawData->DisplayPos to get clipping rectangle in \"viewport\" coordinates")    // imgui.h:2400
    ...
    auto pyClassImDrawList = py::class_<ImDrawList>    // imgui.h:2503
        ...
        .def_readonly("_owner_name", &ImDrawList::_OwnerName, "Pointer to owner window's name for debugging")    // imgui.h:2514
        ...
        .def("clone_output",    // imgui.h:2586
            [](const ImDrawList & self) -> ImDrawList *
            {
        ...
        .def("_calc_circle_auto_segment_count",    // imgui.h:2623
            [](const ImDrawList & self, float radius) -> int
            {
    ...
    auto pyClassImFontAtlas = py::class_<ImFontAtlas>    // imgui.h:2747
        ...
        .def("add_font",    // imgui.h:2751
            [](ImFontAtlas & self, const ImFontConfig * font_cfg) -> ImFont *
            {
        ...
        .def("add_font_default",    // imgui.h:2752
            [](ImFontAtlas & self, const ImFontConfig * font_cfg = NULL) -> ImFont *
            {
        ...
        .def("add_font_from_file_ttf",    // imgui.h:2753
            [](ImFontAtlas & self, const char * filename, float size_pixels, const ImFontConfig * font_cfg = NULL, const ImWchar * glyph_ranges = NULL) -> ImFont *
            {
        ...
        .def("add_font_from_memory_ttf",    // imgui.h:2754
            [](ImFontAtlas & self, void * font_data, int font_size, float size_pixels, const ImFontConfig * font_cfg = NULL, const ImWchar * glyph_ranges = NULL) -> ImFont *
            {
        ...
        .def("add_font_from_memory_compressed_ttf",    // imgui.h:2755
            [](ImFontAtlas & self, const void * compressed_font_data, int compressed_font_size, float size_pixels, const ImFontConfig * font_cfg = NULL, const ImWchar * glyph_ranges = NULL) -> ImFont *
            {
        ...
        .def("add_font_from_memory_compressed_base85_ttf",    // imgui.h:2756
            [](ImFontAtlas & self, const char * compressed_font_data_base85, float size_pixels, const ImFontConfig * font_cfg = NULL, const ImWchar * glyph_ranges = NULL) -> ImFont *
            {
        ...
        .def("get_glyph_ranges_default",    // imgui.h:2780
            [](ImFontAtlas & self) -> const ImWchar *
            {
        ...
        .def("add_custom_rect_regular",    // imgui.h:2800
            [](ImFontAtlas & self, int width, int height) -> int
            {
        ...
        .def("add_custom_rect_font_glyph",    // imgui.h:2801
            [](ImFontAtlas & self, ImFont * font, ImWchar id, int width, int height, float advance_x, const ImVec2 & offset = ImVec2(0, 0)) -> int
            {
        ...
        .def_readonly("font_builder_io", &ImFontAtlas::FontBuilderIO, "Opaque interface to a font builder (default to stb_truetype, can be changed to use FreeType by defining IMGUI_ENABLE_FREETYPE).")    // imgui.h:2834
    ...
    auto pyClassImFont = py::class_<ImFont>    // imgui.h:2848
        ...
        .def_readonly("fallback_glyph", &ImFont::FallbackGlyph, "4-8   // out // = FindGlyph(FontFallbackChar)")    // imgui.h:2858
        .def_readwrite("container_atlas", &ImFont::ContainerAtlas, "4-8   // out //            // What we has been loaded into")    // imgui.h:2861
        .def_readonly("config_data", &ImFont::ConfigData, "4-8   // in  //            // Pointer within ContainerAtlas->ConfigData")    // imgui.h:2862
        ...
        .def("find_glyph",    // imgui.h:2876
            [](const ImFont & self, ImWchar c) -> const ImFontGlyph *
            {
        ...
        .def("calc_word_wrap_position_a",    // imgui.h:2885
            [](const ImFont & self, float scale, const char * text, const char * text_end, float wrap_width) -> const char *
            {
        ...
        .def("is_glyph_range_unused",    // imgui.h:2896
            [](ImFont & self, unsigned int c_begin, unsigned int c_last) -> bool
            {
