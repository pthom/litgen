...
### Generated stub (pyi) file

Below is a stub file generated by `litgen`. It helps developer since it will help the IDE to provide 
autocompletion and code browsing.

As you see, it shows that

* C/C++ Buffers are converted to numpy arrays transparently
* The doc is nicely preserved, as a reference for the user
