...
class MyVirtualClass_publicist : public MyVirtualClass { // helper type for exposing protected functions
public:
    using MyVirtualClass::foo;
    using MyVirtualClass::foo2;
    using MyVirtualClass::foo3;
};
...
void py_init_module_lg_mylib(py::module& m)
{
    ...
    { // <namespace SomeNamespace>
        ...
        { // inner classes & enums of ParentStruct
            auto pyNamespaceSomeNamespace_ClassParentStruct_ClassInnerStruct = py::class_<SomeNamespace::ParentStruct::InnerStruct>
        ...
        auto pyNamespaceSomeNamespace_ClassBlah = py::class_<SomeNamespace::Blah>
