...
void py_init_module_inner_classes(py::module& m)
{
    ...
    // <namespace N>
    auto pyClassParent = py::class_<N::Parent>
        (m, "Parent", "")
        .def(py::init<>()) // implicit default constructor
        .def_readwrite("a", &N::Parent::a, "")
        .def_readwrite("child", &N::Parent::child, "")
        ;
    { // inner classes of Parent
        auto pyClassParent_ClassChild = py::class_<N::Parent::Child>
            (pyClassParent, "Child", "")
            .def(py::init<int>(),
                py::arg("_b") = 0)
            .def_readwrite("b", &N::Parent::Child::b, "")
            .def("add",
                [](N::Parent::Child & self, BoxedFloat & values_0, BoxedFloat & values_1, BoxedFloat & values_2) -> float
                {
