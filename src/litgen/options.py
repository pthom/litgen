...
class LitgenOptions:
    ...
    # by default, this is active for all functions (set it to r"" to disable it)
    ...
    fn_params_adapt_mutable_param_with_default_value__to_autogenerated_named_ctor: bool = True
