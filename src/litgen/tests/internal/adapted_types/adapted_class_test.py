...
def test_class_sibling_qualification() -> None:
    """Test that sibling references inside a nested class are qualified
    with the parent class name (required for mypy)."""
    code = """
    class TextEditor {
    public:
    ...
    code_utils.assert_are_codes_equal(
        ...
        class TextEditor:
            ...
            class CursorSelection:
                ...
                def __init__(
                    self,
                    start: TextEditor.CursorPosition = TextEditor.CursorPosition(),
                    end: TextEditor.CursorPosition = TextEditor.CursorPosition()
                    ) -> None:
                    """Auto-generated default constructor with named params"""
                    pass
            def __init__(self) -> None:
