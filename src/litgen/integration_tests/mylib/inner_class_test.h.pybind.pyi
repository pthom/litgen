...
class some_namespace:  # Proxy class that introduces typings for the *submodule* some_namespace
    ...
    class ParentStruct:
        ...
        def __init__(
            self,
            inner_struct: some_namespace.ParentStruct.InnerStruct = some_namespace.ParentStruct.InnerStruct(),
            inner_enum: some_namespace.ParentStruct.InnerEnum = some_namespace.ParentStruct.InnerEnum.three,
        ) -> None:
